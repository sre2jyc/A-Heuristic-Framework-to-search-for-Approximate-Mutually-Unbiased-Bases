...
if __name__ == "__main__":
    ...
    for run in range(50):
        ...
        R1 = np.random.rand(6,6) - (1j * np.random.rand(6,6))
        R2 = np.random.rand(6,6) + (1j * np.random.rand(6,6))
        R3 = np.random.rand(6,6) - (1j * np.random.rand(6,6))
        R4 = np.random.rand(6,6) + (1j * np.random.rand(6,6))
        R5 = np.random.rand(6,6) + (1j * np.random.rand(6,6))
