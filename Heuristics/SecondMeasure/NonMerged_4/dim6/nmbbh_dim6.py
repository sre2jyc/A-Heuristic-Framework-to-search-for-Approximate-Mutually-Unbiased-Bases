...
if __name__ == "__main__":
    ...
    # print(f"Max Value of Measure 2 : {max(meas2)}")
    # checkBasis(bb1)
    # checkBasis(bb2)
    # checkBasis(bb3)
    # checkBasis(bb4)
    ...
    df.to_csv('nmbbh_heur_dim6.csv')

    # print(checkBasis(NB[0]))
    print(f"Max ASD : {max} --- Drift : {max_meas2}")
    print(f"Corresponding Alpha : {math.sqrt(6) * max_meas2}")
...
# [1, 3, 5, 7], [(0.9095261101634188, [1, 4, 5, 3]